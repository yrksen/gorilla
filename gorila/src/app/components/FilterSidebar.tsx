...
export function FilterSidebar({
  ...
  return (
    <aside className="w-full md:w-64 md:border-r p-6" style={{ background: 'transparent' }}>
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          <button
            ...
            className="w-full px-3 py-2 text-xs text-left border-2 rounded-md bg-white dark:bg-gray-700 dark:text-white dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
          >
          ...
          {isYearDropdownOpen && (
            <>
              ...
              />
              <div className="absolute z-20 mt-1 w-full bg-white dark:bg-gray-700 border dark:border-gray-600 rounded-md shadow-lg max-h-[200px] overflow-y-auto p-2">
      ...
      <div className="mb-6">
        <h3 className="text-[10px] font-semibold uppercase tracking-wide mb-3 dark:text-white opacity-60">Genre</h3>
