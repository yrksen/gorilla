...
export function PaginationControls({
  ...
  if (variant === "mobile") {
    return (
      <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg py-4 px-2 flex items-center justify-center gap-2">
        {/* Skip to First Page */}
        <Button
          variant="outline"
          size="sm"
      ...
      <div className="flex items-center gap-1">
        {showFirstEllipsis && (
          <>
            <button
              onClick={() => onPageChange(1)}
              className="h-8 px-3 rounded-lg text-xs font-mono transition-colors bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 border dark:border-gray-600"
            >
              1
            </button>
